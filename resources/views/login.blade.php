...
<head>
    ...
    <title>Login - E-DDC | Sistem Klasifikasi Perpustakaan</title>
    <meta name="description" content="Login ke sistem E-DDC untuk mengelola koleksi perpustakaan.">
...
<body class="bg-slate-900 font-sans text-slate-800 antialiased min-h-screen flex items-center justify-center relative overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-md px-6 animate-fade-in-up">
        ...
        <div class="text-center mb-8">
            ...
            <p class="mt-3 text-sm font-medium text-slate-400">Masuk ke Sistem Klasifikasi Perpustakaan</p>
        </div>
        ...
        <div class="rounded-2xl border border-white/10 bg-white/[0.07] p-8 shadow-2xl backdrop-blur-xl">
            ...
            @if(session('success'))
            <div class="mb-5 rounded-xl border border-emerald-500/20 bg-emerald-500/10 px-4 py-3 text-sm font-medium text-emerald-300">
                <div class="flex items-center gap-2">
            ...
            <form action="{{ route('login.process') }}" method="POST" class="space-y-5">
                ...
                <div class="flex items-center justify-between">
                    <label class="flex cursor-pointer items-center gap-2">
                        <input type="checkbox" name="remember" class="h-4 w-4 rounded border-white/20 bg-white/5 text-blue-500 focus:ring-blue-500/30">
                        <span class="text-[12px] font-medium text-slate-400">Ingat saya</span>
                    </label>
                </div>
            ...
            <div class="mt-6 text-center text-xs">
                ...
                <a href="{{ route('register') }}" class="font-semibold text-blue-400 hover:text-blue-300 transition-colors ml-1">Daftar sekarang</a>
            </div>
        </div>
